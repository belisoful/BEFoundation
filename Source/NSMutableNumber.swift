...
/*
 ...
 public extension NSMutableNumber {
 ...
 @objc enum NSMutableNumberMathOperation: Int {
 case add
 case subtract
 case multiply
 case divide
 ...
 private func numberOperation(operation: NSMutableNumberMathOperation, first: NSNumber, second: NSNumber) -> NSNumber {
 ...
 ///Add two numbers
 public func + (first: NSMutableNumber, second:NSMutableNumber) -> NSMutableNumber {
 ...
 ///Divide two numbers
 public func pow (first: NSMutableNumber, second:NSMutableNumber) -> NSMutableNumber {
 ...
 public prefix func ~(first: NSMutableNumber) -> NSMutableNumber {
 ...
 public func < (first: NSMutableNumber, second:NSMutableNumber) -> ObjCBool {
 return true;
 }
 public func <= (first: NSMutableNumber, second:NSMutableNumber) -> ObjCBool {
 return true;
 ...
 ///Postfix decrement two numbers
 public postfix func -- (first: NSMutableNumber) -> NSMutableNumber {
 return numberOperation(operation: .subtract, first: first, second: 1)
 }
