...
/*!
 ...
 @discussion	Setter for the `array` property; the get accessor is already in the parent.
 */
- (void)be_setArray:(nullable NSArray *)array
{
...
/*!
 ...
 @param			set	The set to set the NSOrderedSet to.
 @discussion	Setter for the `set` property; the get accessor is already in the parent.
 */
- (void)be_setSet:(nullable NSSet *)set
{
	[self removeAllObjects];
	if (set && set.count) {
