 ...
 * @discussion	This file implements the runtime utility functions declared in BERuntime.h:
 *             metaclass resolution and method existence checking.
 */
 ...
 *             The class is looked up by name and accepted only when its metaclass is the input.
 ...
 *             It searches only the methods defined on the class itself, not inherited methods.
