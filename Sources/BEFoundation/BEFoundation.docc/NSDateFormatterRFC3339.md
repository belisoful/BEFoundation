...
This category adds convenience methods to `NSDateFormatter` for working with RFC 3339 formatted dates. RFC 3339 is a profile of ISO 8601 that defines the date and time format for Internet protocols.
...
> `dateFromString:` returns `nil` for each:
>
