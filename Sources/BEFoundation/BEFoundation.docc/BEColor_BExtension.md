...
The 141 CSS/SVG color keywords live in <doc:BEColor_BEWebColor>, which extends `BEColor` with a
constant, a class property, and a name lookup for each one.

```objc
BEColor *sky = BEColor.webDeepSkyBlue;
```
